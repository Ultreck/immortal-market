    ...
    <>
      {isOverviewLoading ? (
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
          ...
          <Card className="px-6 py-4">
            <div className="text-xl md:text-3xl font-semibold text-gray-800">Basic</div>
            <div className="flex items-center mb-1">
              <p className="text-sm text-ellipsis whitespace-nowrap overflow-hidden mt-1">Subscription</p>
            </div>
          </Card>
          <Card className="px-6 py-4">
            <div className="text-xl md:text-3xl font-semibold text-gray-800">{formatCurrency(0)}</div>
            <div className="flex items-center mb-1">
...
export default BusinessOverviewStats;
