          ...
          !success ? (
            <>
              <div className="max-w-xl mx-auto flex justify-between items-center">
                ...
                <IconButton
                  icon={ <IconX size="20"/> }
                  onClick={ onClose }
                  size="sm" variant="outlined" color="red" className="mr-3" rounded
                />
              </div>
              {
                !file ? (
                      ...
                      <div className="my-auto">
                        ...
                        <form onSubmit={ handleSubmit(onSubmit) }>
                          ...
                          <div className="mt-3 space-y-3">
                            <Select
                              label="What type of document is this?" bordered placeholder="Select category"
            ...
            <div className="h-full rounded-xl px-10 py-24 flex flex-col items-center justify-center text-center">
              ...
              <p className="max-w-xs mt-2">
                Thank you, we have received your file
              </p>
