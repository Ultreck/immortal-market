...
import { TbChevronLeft, TbLayoutList } from 'react-icons/tb';
...
const Sidebar = () => {
  ...
  return (
    <div className="h-full border-r border-default-200 dark:border-default-100 bg-[#f4f5f6] dark:bg-default-50/50 rounded-r-2xl">
