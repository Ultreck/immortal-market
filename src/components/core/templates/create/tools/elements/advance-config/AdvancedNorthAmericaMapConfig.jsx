...
import {namesOfNorthAmericanCountries } from '@/lib/helper';

const AdvancedNorthAmericaMapConfig = ({ element, onChange }) => {
    ...
    const handleAddMapValues = (map) => {
      ...
      if(namesOfNorthAmericanCountries.includes(capitalizedWord)){
        ...
        <div className="flex flex-col bg-gray-100 dark:bg-slate-900 items-start px-3 space-y-5">
          ...
          <div className="text flex justify-between items-center w-full my-5">
            ...
            <Checkbox
              ...
              onValueChange={(v) => onChange({ ...element, showLabels: v ? true : false })}
            >
...
AdvancedNorthAmericaMapConfig.propTypes = ElementPropTypes;

export default AdvancedNorthAmericaMapConfig