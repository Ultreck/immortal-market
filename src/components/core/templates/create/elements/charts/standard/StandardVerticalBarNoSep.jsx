...
const StandardVerticalBarNoSep = ({ element }) => {
  return <StandardVerticalBarNoSepContent element={element} />;
};

StandardVerticalBarNoSep.propTypes = ElementPropTypes;

export const StandardVerticalBarNoSepContent = ({ element, isChartWrapperDisabled = false }) => {
