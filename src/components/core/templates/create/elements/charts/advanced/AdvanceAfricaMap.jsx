...
import { africaCountries } from '@/lib/helper';
...
const AdvanceAfricaMap = ({ element, active, highlighted, width, onClick, onChange }) => {
    ...
    >
      ...
      >
        ...
        {element.config.data.map((item) => {
          const key = Object.keys(africaCountries).find((x) => item.label.toLowerCase().includes(x.toLowerCase()));
          if (!key) return null;
...
AdvanceAfricaMap.propTypes = ElementPropTypes;
export default AdvanceAfricaMap;
