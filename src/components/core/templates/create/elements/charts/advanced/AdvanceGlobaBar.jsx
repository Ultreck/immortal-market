...
const AdvanceGlobaBar = ({ element, onChange }) => {
  return <AdvanceGlobaBarContent element={element} onChange={onChange} />;
};

AdvanceGlobaBar.propTypes = {
  element: PropTypes.object.isRequired,
  onChange: PropTypes.func.isRequired,
};

export const AdvanceGlobaBarContent = ({ element, onChange }) => {
...
AdvanceGlobaBarContent.propTypes = {
  element: PropTypes.object.isRequired,
  onChange: PropTypes.func.isRequired,
};

export default AdvanceGlobaBar;
