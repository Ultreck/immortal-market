...
import { Bar, CartesianGrid, ComposedChart, XAxis, YAxis, Legend, Line, Area } from 'recharts';
...
const StandartAreaLineChart = ({ element, active, highlighted, width, onClick, onChange }) => {
...
export default StandartAreaLineChart;