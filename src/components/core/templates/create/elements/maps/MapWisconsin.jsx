...
const MapWisconsin = ({ element, active, highlighted, width, onClick, onChange }) => {
  return (
    <ElementWrapper
      element={element}
      onClick={onClick}
      ...
      fit
    >
      <MapWisconsinContent element={element} />
    </ElementWrapper>
  );
};
...
export const MapWisconsinPreview = () => {
  return <MapWisconsinContent element={{ config: { data: [], fill: '#f9fafb', stroke: '#f9fafb' } }} />;
};

export const MapWisconsinContent = ({ element }) => {
