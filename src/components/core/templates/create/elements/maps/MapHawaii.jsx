...
export const MapHawaiiPreview = () => {
  return <MapHawaiiContent element={{ config: { data: [], fill: '#f9fafb', stroke: '#f9fafb' } }} present={false} />;
};

const MapHawaiiContent = ({ element, present = true }) => {
  ...
  return (
    ...
    >
      <path
        ...
        onMouseMove={(e) => handleMouseMove(e, 'Hawaii')}
      ...
      <path
        ...
        data-y="83"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Maui')}
        onMouseLeave={handleMouseLeave}
      />
      <path
        ...
        data-y="3"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Kauai')}
        onMouseLeave={handleMouseLeave}
      />
      <path
        ...
        data-y="42"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Honolulu')}
        onMouseLeave={handleMouseLeave}
      />
      <path
        ...
        data-y="84"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Kalawao')}
        onMouseLeave={handleMouseLeave}
      />
