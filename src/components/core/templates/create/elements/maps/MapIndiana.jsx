...
export const MapIndianaPreview = () => {
  return <MapIndianaContent element={{ config: { data: [], fill: '#f9fafb', stroke: '#f9fafb' } }} present={false} />;
};

const MapIndianaContent = ({ element, present = true }) => {
  ...
  return (
    ...
    >
      ...
      <path
        ...
        data-y="38"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'LaPorte')}
        onMouseLeave={handleMouseLeave}
      />
      <path
      ...
      <path
        ...
        data-y="397"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Posey')}
        onMouseLeave={handleMouseLeave}
      />
      <path
      ...
      <path
        ...
        data-y="390"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Warrick')}
        onMouseLeave={handleMouseLeave}
      />
      <path
        ...
        data-y="37"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Kosciusko')}
        onMouseLeave={handleMouseLeave}
      />
      <path
      ...
      <path
        ...
        data-y="203"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Parke')}
        onMouseLeave={handleMouseLeave}
      />
      <path
      ...
      <path
        ...
        data-y="157"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Fountain')}
        onMouseLeave={handleMouseLeave}
      />
      <path
        ...
        data-y="241"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Vigo')}
        onMouseLeave={handleMouseLeave}
      />
      <path
      ...
      <path
        ...
        data-y="135"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Tippecanoe')}
        onMouseLeave={handleMouseLeave}
      />
      <path
        ...
        data-y="317"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Jennings')}
        onMouseLeave={handleMouseLeave}
      />
      <path
      ...
      <path
        ...
        data-y="37"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Elkhart')}
        onMouseLeave={handleMouseLeave}
      />
      <path
      ...
      <path
        ...
        data-y="359"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Dubois')}
        onMouseLeave={handleMouseLeave}
      />
      <path
        ...
        data-y="269"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Bartholomew')}
        onMouseLeave={handleMouseLeave}
      />
      <path
      ...
      <path
        ...
        data-y="38"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Starke')}
        onMouseLeave={handleMouseLeave}
      />
      <path
      ...
      <path
        ...
        data-y="206"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Hendricks')}
        onMouseLeave={handleMouseLeave}
      />
      <path
      ...
      <path
        ...
        data-y="304"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Dearborn')}
        onMouseLeave={handleMouseLeave}
      />
      <path
      ...
      <path
        ...
        data-y="134"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Jay')}
        onMouseLeave={handleMouseLeave}
      />
      <path
        ...
        data-y="1"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'LaGrange')}
        onMouseLeave={handleMouseLeave}
      />
      <path
      ...
      <path
        ...
        data-y="96"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Huntington')}
        onMouseLeave={handleMouseLeave}
      />
      <path
      ...
      <path
        ...
        data-y="341"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Switzerland')}
        onMouseLeave={handleMouseLeave}
      />
      <path
      ...
      <path
        ...
        data-y="203"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Vermillion')}
        onMouseLeave={handleMouseLeave}
      />
      <path
      ...
      <path
        ...
        data-y="398"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Vanderburgh')}
        onMouseLeave={handleMouseLeave}
      />
      <path
      ...
      <path
        ...
        data-y="135"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Blackford')}
        onMouseLeave={handleMouseLeave}
      />
      <path
