...
const MapSouthDakota = ({ element, active, highlighted, width, onClick, onChange }) => {
  return (
    <ElementWrapper
      element={element}
      onClick={onClick}
      ...
      fit
    >
      <MapSouthDakotaContent element={element} />
    </ElementWrapper>
  );
};
...
export const MapSouthDakotaPreview = () => {
  return <MapSouthDakotaContent element={{ config: { data: [], fill: '#f9fafb', stroke: '#f9fafb' } }} />;
};

const MapSouthDakotaContent = ({ element }) => {
