...
const MapKentucky = ({ element }) => {
  return <MapKentuckyContent element={element} />;
};

export const MapKentuckyPresent = ({ element }) => {
  return <MapKentuckyContent element={element} />;
};
...
const MapKentuckyContent = ({ element, present = true }) => {
  ...
  return (
    <svg ref={el} width="100%" viewBox="0 0 401 177" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <path
        d="M293.718 64.9155L294.084 67.0455L298.846 68.6425L301.986 72.2995L302.98 74.9585L305.23 77.7485L304.34 78.5445L304.707 83.0575L302.456 84.1185L294.346 82.2615L288.433 70.0395L293.09 66.0475L293.718 64.9155Z"
...
MapKentucky.propTypes = ElementPropTypes;
MapKentuckyPresent.propTypes = {
