...
const MapOhio = ({ element, active, highlighted, width, onClick, onChange }) => {
  return (
    <ElementWrapper
      element={element}
      onClick={onClick}
      ...
      fit
    >
      <MapOhioContent element={element} />
    </ElementWrapper>
  );
};
...
export const MapOhioPreview = () => {
  return <MapOhioContent element={{ config: { data: [], fill: '#f9fafb', stroke: '#f9fafb' } }} />;
};

export const MapOhioContent = ({ element }) => {
