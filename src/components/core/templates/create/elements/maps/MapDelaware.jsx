...
const MapDelaware = ({ element, active, highlighted, width, onClick, onChange }) => {
  return (
    <ElementWrapper
      element={element}
      onClick={onClick}
      ...
      fit
    >
      <MapDelawareContent element={element} />
    </ElementWrapper>
  );
};
...
export const MapDelawarePreview = () => {
  return <MapDelawareContent element={{ config: { data: [], fill: '#f9fafb', stroke: '#f9fafb' } }} />;
};

export const MapDelawareContent = ({ element }) => {
