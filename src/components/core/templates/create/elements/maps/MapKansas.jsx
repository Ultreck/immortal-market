...
const MapKansas = ({ element, active, highlighted, width, onClick, onChange }) => {
  return (
    <ElementWrapper
      element={element}
      onClick={onClick}
      ...
      fit
    >
      <MapKansasContent element={element} />
    </ElementWrapper>
  );
};
...
export const MapKansasPreview = () => {
  return <MapKansasContent element={{ config: { data: [], fill: '#f9fafb', stroke: '#f9fafb' } }} />;
};

const MapKansasContent = ({ element }) => {
