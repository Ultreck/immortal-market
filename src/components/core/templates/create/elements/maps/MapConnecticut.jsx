...
const MapConnecticut = ({ element, active, highlighted, width, onClick, onChange }) => {
  return (
    <ElementWrapper
      element={element}
      onClick={onClick}
      ...
      fit
    >
      <MapConnecticutContent element={element} />
    </ElementWrapper>
  );
};
...
export const MapConnecticutPreview = () => {
  return <MapConnecticutContent element={{ config: { data: [], fill: '#f9fafb', stroke: '#f9fafb' } }} />;
};

export const MapConnecticutContent = ({ element }) => {
