...
const MapMoldova = ({ element }) => {
  return <MapMoldovaContent element={element} />;
};

export const MapMoldovaPresent = ({ element }) => {
  return <MapMoldovaContent element={element} />;
};
...
const MapMoldovaContent = ({ element, present = true }) => {
  ...
  return (
    ...
    >
      <path
        d="M322.611 284.661L316.109 279.406L307.384 278.524L309.935 268.391L300.714 266.612L299.959 266.757L303.85 259.245L300.228 247.144L291.89 250.494H286.301L282.589 247.043L281.1 239.758L281.686 228.397L277.001 225.547L270.747 228.979L264.206 225.155L264.007 220.165L269.378 217.908L269.963 208.017L263.035 201.892L257.566 195.923L264.107 186.224L256.296 186.706L250.925 183.344L253.069 173.774L267.333 166.524L267.194 164.794L271.412 163.885L272.722 174.916L281.497 174.974L281.378 167.021L287.621 165.131L290.103 167.944L291.86 181.062L287.761 183.095L290.53 197.033L282.272 200.083L287.781 206.326L294.302 205.757L292.902 223.613L297.726 230.767L303.642 229.372L310.153 239.366L320.556 236.68L320.646 241.718L326.333 248.319L330.074 256.059L329.737 269.549L327.534 271.559L330.711 278.264L330.026 283.55L322.611 284.661ZM266.579 163.987L264.623 166.23L249.843 169.263L242.587 160.498L245.774 152.706L235.758 144.378L235.818 136.452L232.294 133.317L232.691 112.551L232.106 102.658L233.376 95.3101L227.48 91.4776L216.383 87.9557L216.671 83.942L212.571 76.9918L206.973 76.7837L201.405 69.8415L195.35 67.972L190.566 72.8686L187.539 69.0551L198.764 61.0218L185.077 54.2736L185.325 49.8856L189.821 46.4175L198.744 49.6915L203.301 53.5449L215.152 53.0243L220.105 57.2619L218.607 67.3926L226.815 78.4004L232.016 76.5916L236.245 81.3051L240.95 81.1568L242.597 75.7315L250.31 74.9899L252.394 89.1104L257.427 89.4797L253.357 99.4064L259.432 102.88L258.082 109.555L253.824 114.692L256.305 119.736L253.903 126.044L254.936 130.299L252.335 136.025L245.645 138.246L251.322 154.144L257.446 152.603L260.474 156.42L264.931 154.453L266.579 163.987Z"
        stroke={element.config.stroke}
        fill={assignColor('Unitatea Teritorială din Stînga Nistrului')}
      ...
      <path
        ...
        stroke={element.config.stroke}
        fill={assignColor('Unitatea Teritorială Autonomă Găgăuzia (UTAG)')}
      ...
      <path
        d="M195.42 118.364L196.323 117.538L199.162 113.23L206.874 114.116L209.415 107.459L217.227 105.199L223.183 99.6124L227.48 91.4775L233.376 95.31L232.106 102.657L232.691 112.551L232.294 133.317L235.818 136.452L235.758 144.378L224.254 134.686L218.1 139.394L210.388 138.217L204.233 131.153L203.748 130.078L195.25 122.934L195.42 118.364Z"
        stroke={element.config.stroke}
        fill={assignColor('Rezina')}
        data-name="Rezina"
        data-x="195"
        data-y="118"
        className="hover:brightness-90"
...
MapMoldova.propTypes = ElementPropTypes;
MapMoldovaPresent.propTypes = {
