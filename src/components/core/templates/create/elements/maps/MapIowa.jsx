...
const MapIowa = ({ element, active, highlighted, width, onClick, onChange }) => {
  return (
    <ElementWrapper
      element={element}
      onClick={onClick}
      ...
      fit
    >
      <MapIowaContent element={element} />
    </ElementWrapper>
  );
};
...
export const MapIowaPreview = () => {
  return <MapIowaContent element={{ config: { data: [], fill: '#f9fafb', stroke: '#f9fafb' } }} />;
};

const MapIowaContent = ({ element }) => {
