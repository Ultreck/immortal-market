...
const MapNewHampshire = ({ element }) => {
  return <MapNewHampshireContent element={element} />;
};

export const MapNewHampshirePresent = ({ element }) => {
  return <MapNewHampshireContent element={element} />;
};
...
export const MapNewHampshireContent = ({ element, present = true }) => {
  ...
  return (
    <svg ref={el} width="100%" viewBox="0 0 225 442" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M187.63 176.434L183.516 176.604L183.637 184.376L176.982 184.714L158.225 183.194L151.69 201.251L151.086 209.005L146.73 208.331L147.214 203.781L145.761 196.192L142.373 193.999L141.042 188.091L138.622 188.598L135.233 182.349L127.49 179.984L119.14 181.504L117.688 173.053L105.707 167.641L104.498 168.318L96.3896 155.961L103.771 154.436L108.612 150.2L109.459 147.488L118.776 139.347L119.14 134.765L116.962 131.37L120.712 128.992L121.923 123.896L120.833 114.374L117.929 112.844L116.478 106.547L112.121 97.35L119.019 90.3621L122.286 78.0769L128.578 70.9043L125.674 65.0937L126.158 61.8455L123.133 57.3979L127.731 53.2909L130.152 40.789L132.935 39.0745L136.928 33.2449L136.081 30.5009L140.437 18.4843L136.323 14.8765L143.099 14.3613L148.182 7.48524L154.232 2.66922L161.009 11.096L172.504 12.2993L176.982 2.66922L178.918 1.63672L180.975 39.7605L183.758 86.7803L185.089 113.013L185.694 135.783L187.63 176.434Z"
...
MapNewHampshire.propTypes = ElementPropTypes;
MapNewHampshirePresent.propTypes = {
