...
const MapNorthernIreland = ({ element }) => {
  return <MapNorthernIrelandContent element={element} />;
};

export const MapNorthernIrelandPresent = ({ element }) => {
  return <MapNorthernIrelandContent element={element} />;
};
...
export const MapNorthernIrelandContent = ({ element, present = true }) => {
  ...
  return (
    ...
    >
      <path
        d="M179.367 122.796L179.258 128.2L171.874 131.08L170.246 148.562L178.203 164.552L175.44 167.294L174.777 179.401L164.879 190.299L156.149 191.605L152.97 197.84L139.088 199.882L136.267 203.093L117.142 207.348L122.678 217.362L121.898 223.831L129.763 223.869L130.998 230.727L134.759 235.014L143.11 232.34L145.43 245.225L149.859 253.816L149.502 260.526L136.726 263.98L132.877 268.62L133.838 277.723L123.098 278.766L124.167 288.252L113.576 282.43L110.947 277.59L106.169 278.165L98.929 285.818L93.666 282.68L88.189 284.96L79.511 278.323L79.044 274.343L69.779 265.722L61.575 264.343L52.379 266.462L45.272 262.315L45.227 251.619L41.2 241.612L32.743 240.649L24.864 227.23L16.739 224.62L12.64 217.397L1.368 206.323L1 199.428L8.181 199.443L11.931 194.921L18.697 194.762L18.821 190.053L24.036 180.147L32.239 183.234L45.807 182.51L54.112 172.443L61.12 166.859L68.114 164.429L74.805 159.844L92.957 156.062L96.251 153.014L103.538 155.303L110.088 149.271L113.545 143.112L124.098 138.014L126.05 131.668L132.591 133.56L137.565 128.277L153.534 128.912L158.861 124.766L169.828 121.215L179.367 122.796Z"
        stroke={element.config.stroke}
        data-name="Fermanagh and Omagh"
      ...
      <path
        ...
        stroke={element.config.stroke}
        data-name="Newry, Mourne and Down"
      ...
      <path
        ...
        stroke={element.config.stroke}
        data-name="Causeway Coast and Glens"
      ...
      <path
        ...
        stroke={element.config.stroke}
        data-name="Armagh City, Banbridge and Craigavon"
      ...
      <path
        ...
        stroke={element.config.stroke}
        data-name="Antrim and Newtownabbey"
      ...
      <path
        ...
        stroke={element.config.stroke}
        data-name="Lisburn and Castlereagh"
...
MapNorthernIreland.propTypes = ElementPropTypes;
MapNorthernIrelandPresent.propTypes = {
