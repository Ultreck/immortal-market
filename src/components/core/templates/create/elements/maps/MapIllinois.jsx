...
const MapIllinois = ({ element, active, highlighted, width, onClick, onChange }) => {
  return (
    <ElementWrapper
      element={element}
      onClick={onClick}
      ...
      fit
    >
      <MapIllinoisContent element={element} />
    </ElementWrapper>
  );
};
...
export const MapIllinoisPreview = () => {
  return <MapIllinoisContent element={{ config: { data: [], fill: '#f9fafb', stroke: '#f9fafb' } }} />;
};

const MapIllinoisContent = ({ element }) => {
