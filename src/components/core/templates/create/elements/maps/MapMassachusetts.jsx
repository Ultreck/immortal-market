...
const MapMassachusetts = ({ element }) => {
  return <MapMassachusettsContent element={element} />;
};

export const MapMassachusettsPresent = ({ element }) => {
  return <MapMassachusettsContent element={element} />;
};
...
const MapMassachusettsContent = ({ element, present = true }) => {
  ...
  return (
    ...
    >
      <path
        d="M226.934 110.455V114.208L224.374 116.309L224.708 131.451L191.319 132.65L191.207 130.403L153.7 129.354L153.812 109.705L146.466 109.855L139.454 106.401L139.788 103.246L144.24 97.2345L145.242 87.3065L138.23 88.6615L137.228 81.1345L133.889 82.4895L133.778 74.6555L137.339 67.7205L136.338 61.8375L141.569 56.7055L138.898 53.8355L138.007 47.1875L140.456 41.8965L143.461 41.4425L143.238 34.1805L138.564 32.5155L137.339 25.0945L180.078 26.7615L184.752 32.3645L186.088 37.9635L193.879 37.0555L206.121 42.0475L204.563 54.2885L209.349 55.1955L211.13 50.9655L220.145 52.3255L220.924 55.7995L217.808 62.5915L219.588 63.7985L217.919 72.0935L210.462 81.5855L215.025 87.3065L218.921 84.8985L226.044 84.4465L223.929 93.0245L214.803 95.1295L213.022 101.443L215.248 104.749L223.595 105.65L226.934 110.455Z"
        fill={assignColor('Worcester')}
...
MapMassachusetts.propTypes = ElementPropTypes;
MapMassachusettsPresent.propTypes = {
