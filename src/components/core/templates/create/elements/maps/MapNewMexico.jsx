...
export const MapNewMexicoPreview = () => {
  return <MapNewMexicoContent element={{ config: { data: [], fill: '#f9fafb', stroke: '#f9fafb' } }} present={false} />;
};

export const MapNewMexicoContent = ({ element, present = true }) => {
  ...
  return (
    ...
    >
      <path
        ...
        onMouseMove={(e) => handleMouseMove(e, 'Chaves')}
      ...
      <path
        ...
        data-y="1"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Rio Arriba')}
        onMouseLeave={handleMouseLeave}
      />
      <path
      ...
      <path
        ...
        data-y="202"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Socorro')}
        onMouseLeave={handleMouseLeave}
      />
      <path
      ...
      <path
        ...
        data-y="276"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Catron')}
        onMouseLeave={handleMouseLeave}
      />
      <path
        ...
        data-y="80"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'McKinley')}
        onMouseLeave={handleMouseLeave}
      />
      <path
      ...
      <path
        ...
        data-y="135"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Cibola')}
        onMouseLeave={handleMouseLeave}
      />
      <path
        ...
        data-y="276"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Sierra')}
        onMouseLeave={handleMouseLeave}
      />
      <path
        ...
        data-y="63"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Sandoval')}
        onMouseLeave={handleMouseLeave}
      />
      <path
      ...
      <path
        ...
        data-y="162"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Quay')}
        onMouseLeave={handleMouseLeave}
      />
      <path
        ...
        data-y="399"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Hidalgo')}
        onMouseLeave={handleMouseLeave}
      />
      <path
        ...
        data-y="388"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Dona Ana')}
        onMouseLeave={handleMouseLeave}
      />
      <path
        ...
        data-y="388"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Lea')}
        onMouseLeave={handleMouseLeave}
      />
      <path
      ...
      <path
        ...
        data-y="147"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Guadalupe')}
        onMouseLeave={handleMouseLeave}
      />
      <path
        ...
        data-y="213"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Roosevelt')}
        onMouseLeave={handleMouseLeave}
      />
      <path
        ...
        data-y="155"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Torrance')}
        onMouseLeave={handleMouseLeave}
      />
      <path
      ...
      <path
        ...
        data-y="59"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Taos')}
        onMouseLeave={handleMouseLeave}
      />
      <path
        ...
        data-y="342"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Luna')}
        onMouseLeave={handleMouseLeave}
      />
      <path
        ...
        data-y="175"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'DeBaca')}
        onMouseLeave={handleMouseLeave}
      />
      <path
        ...
        data-y="63"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Mora')}
        onMouseLeave={handleMouseLeave}
      />
      <path
        ...
        data-y="82"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Santa Fe')}
        onMouseLeave={handleMouseLeave}
      />
      <path
      ...
      <path
        ...
        data-y="161"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Valencia')}
        onMouseLeave={handleMouseLeave}
      />
      <path
        ...
        data-y="141"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Bernalillo')}
        onMouseLeave={handleMouseLeave}
      />
      <path
        ...
        data-y="86"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Los Alamos')}
        onMouseLeave={handleMouseLeave}
      />
