...
export const MapWyomingPreview = () => {
  return <MapWyomingContent element={{ config: { data: [], fill: '#f9fafb', stroke: '#f9fafb' } }} present={false} />;
};

const MapWyomingContent = ({ element, present = true }) => {
  ...
  return (
    ...
    >
      ...
      <path
        ...
        data-y="216"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Sweetwater')}
        onMouseLeave={handleMouseLeave}
      />
      <path
      ...
      <path
        ...
        data-y="216"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Sublette')}
        onMouseLeave={handleMouseLeave}
      />
      <path
      ...
      <path
        ...
        data-y="120"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Natrona')}
        onMouseLeave={handleMouseLeave}
      />
      <path
      ...
      <path
        ...
        data-y="80"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Teton')}
        onMouseLeave={handleMouseLeave}
      />
      <path
        ...
        data-y="120"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Converse')}
        onMouseLeave={handleMouseLeave}
      />
      <path
      ...
      <path
        ...
        data-y="1"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Big Horn')}
        onMouseLeave={handleMouseLeave}
      />
      <path
        ...
        data-y="120"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Hot Springs')}
        onMouseLeave={handleMouseLeave}
      />
      <path
        ...
        data-y="120"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Washakie')}
        onMouseLeave={handleMouseLeave}
      />
      <path
      ...
      <path
        ...
        data-y="262"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Laramie')}
        onMouseLeave={handleMouseLeave}
      />
      <path
        ...
        data-y="120"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Niobrara')}
        onMouseLeave={handleMouseLeave}
      />
      <path
        ...
        data-y="66"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Weston')}
        onMouseLeave={handleMouseLeave}
      />
      <path
        ...
        data-y="628V230"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Goshen')}
        onMouseLeave={handleMouseLeave}
      />
      <path
      ...
      <path
        ...
        data-y="268"
        className="hover:brightness-90"
        onMouseMove={(e) => handleMouseMove(e, 'Uinta')}
        onMouseLeave={handleMouseLeave}
      />
