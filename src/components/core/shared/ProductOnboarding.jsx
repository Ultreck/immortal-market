...
const ProductOnboarding = ({ product, onStart, isLoading }) => {
  return (
    <div className="bg-slate-50">
      <div
        className={ classNames("fixed z-[1] bottom-0 w-2/4 md:w-1/4 h-full rounded-tr-[300px] opacity-5", product.colors.bg) }
      />
        ...
        <div className="md:h-screen grid md:grid-cols-12 gap-12 md:gap-16 items-center py-12">
          ...
          <div className="md:col-span-5">
            <div className="flex items-center">
              <div
                className={ classNames('w-10 h-10 rounded-3xl flex items-center justify-center text-white', product.colors.bg) }
              >
