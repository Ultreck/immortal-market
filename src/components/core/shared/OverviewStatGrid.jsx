...
const OverviewStatGrid = () => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2  gap-4  font-Lato">
        <Card className="pt-6 rounded-lg shadow-md flex flex-col gap-4 items-center  min-h-40 overflow-hidden">
           <ClockIcon/>
