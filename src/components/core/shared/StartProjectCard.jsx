...
const StartProjectCard = () => {
  return (
    <Card className="card-shadow px-10 py-8 flex flex-col justify-center">
      ...
      <div className="flex flex-wrap justify-between gap-x-4 gap-y-3 mt-8 mb-1">
        <Chip
          size="lg"
          variant="flat"
          color="default"
        ...
        <Chip
          ...
          title="Add"
        >
          <div className="flex flex-row items-center space-x-1 text-default-500">
            <TbPlus size="28" />
          </div>
        </Chip>
      </div>
