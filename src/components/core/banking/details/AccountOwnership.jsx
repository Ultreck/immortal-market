        ...
        <Card className="md:col-span-4">
          ...
          <div className="divide-y divide-gray-300">
            <div className="px-8 py-2">
              {highlight.transfer_to?.length > 10
                ? `10+ transfer receipt`
                : `${highlight.transfer_to?.length} transfer receipt`}
            </div>
            <div className="px-8 py-2">{highlight.transfer_to?.[0]?.name} most frequent</div>
          </div>
          <h3 className="font-medium px-8 pt-6 pb-4">Incoming sender</h3>
          <div className="divide-y divide-gray-300">
            <div className="px-8 py-2">
              {highlight.transfer_from?.length > 10
                ? `10+ depositors`
                : `${highlight.transfer_from?.length} depositor(s)`}
            </div>
            <div className="px-8 py-2">{highlight.transfer_from?.[0]?.name} most frequent</div>
          </div>
        </Card>
