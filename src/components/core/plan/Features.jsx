...
//   return content === true ? <Checkbox /> : content;
// };
        ...
        <table className="min-w-full border border-gray-200 dark:border-gray-500 divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200 ">
            {pricingData.map((row, index) => (
              <tr key={index} className={ index % 2 === 0 ? 'bg-[#e0e7e3]/50 dark:bg-[#18181b]' : 'bg-[#e0e7e3] dark:bg-[#18181b]'}>
                <td className="px-6 py-6 whitespace-nowrap text-sm font-medium text-gray-600 dark:text-gray-400 border border-gray-200 dark:border-zinc-800">   
                    <div className="flex ">
                        ...
                        <Tooltip   showArrow content={<span className="text-gray-500">More details on <br /> {row.feature}</span>}>
                ...
                <td className="px-6 py-6 whitespace-nowrap text-sm text-gray-500 border border-gray-200 dark:border-zinc-800">
                  <div className=" flex items-center justify-center">{renderCellContent(row.free)}</div>  </td>
                <td className="px-6 py-6 whitespace-nowrap text-sm text-gray-500 border border-gray-200 dark:border-zinc-800">
                <div className=" flex items-center justify-center">{renderCellContent(row.standard)}</div></td>
                <td className="px-6 py-6 whitespace-nowrap text-sm text-gray-500 border border-gray-200 dark:border-zinc-800">
                <div className=" flex items-center justify-center">{renderCellContent(row.teams)}</div></td>
                <td className="px-6 py-6 whitespace-nowrap text-sm text-gray-500 border border-gray-200 dark:border-zinc-800">
