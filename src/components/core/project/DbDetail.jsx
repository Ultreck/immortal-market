...
const DbDetails = () => {
  ...
  return (
    <div className="flex flex-col border dark:border-none shadow-xl bg-white rounded-md  dark:bg-zinc-800   py-10 px-4">
        <Title title={'Enter Credential'} size={'sm'} sub={"enter DB details"}/>
