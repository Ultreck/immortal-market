    ...
    <>
      <div className="bg-[#11161b] text-white pt-12 md:pt-16 pb-10 md:pb-12 relative">
        ...
        <div className="container !max-w-5xl">
          <h1 className="text-3xl md:text-4xl font-semibold max-w-lg flex items-center">Account settings</h1>
          <p className="mt-2 md:mt-3 opacity-75">Manage your account settings here</p>
        </div>
      </div>
                ...
                <div className="md:col-span-4">
                  <Card className="overflow-hidden">
                    <div className="flex flex-col px-8 md:px-10 pt-10 pb-8">
                      ...
                      />
                      <div className="mt-3">
                        <h2 className="leading-0 font-medium">
