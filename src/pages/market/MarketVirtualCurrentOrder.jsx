...
const MarketVirtualCurrentOrder = ({ shouldStart, setWinning, data }) => {
              ...
              <Card key={order._id} className="rounded-xl p-5 shadow-sm hover:shadow-md transition">
                <div>
                  ...
                  <div className="mt-4 flex items-center justify-between text-sm text-gray-400">
                    ...
                    <span
                      className={`px-3 py-1 text-xs font-medium rounded-full bg-green-700 text-white`}
                    >
                      {'Active'}
                    </span>
                  </div>
...
export default MarketVirtualCurrentOrder;
