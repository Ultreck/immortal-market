...
const PredictVirtual = () => {
  return (
    <div>
      <div className="flex flex-col px-8 py-4 fixed top-0 right-0 h-screen w-[400px] overflow-y-auto border-l border-default-200/50 dark:border-default-50">
        <Tabs
          aria-label="Options"
          variant="bordered"
          color="primary"
          ...
          <Tab key="music" title="Virtuals">
            <div className="space-y-6">
              ...
              <div className="bg-default-100 px-8 py-6 rounded-2xl">
                <div className="flex space-x-4">
                  <img src="/images/accessbank.png" alt="" width="60" />
                  <p>Will access do a big volume tommorrow more than 50% or so</p>
                </div>
                <div className="mt-10 space-y-4">
                  <div className="flex justify-between items-center">
                    <p>Above 2%</p>
