...
const EquityMarketPrediction = () => {
  return (
    <div className={`mt-5 w-full border rounded-lg px-5 py-5 dark:border-default-200`}>
      <div className="text">
        <div className="text">
          ...
          <div className="text-center mt-2 grid grid-cols-12 gap-1">
            <div className="text-start col-span-2 text-xl">Equity</div>
            <div className="text col-span-1"></div>
            <div className="dark:text-gray-400 grid dark:bg-gray-600 bg-gray-200 grid-cols-3 col-span-4">
            ...
            {betData.map((value, index) => (
              <div key={index} className="text-center grid grid-cols-12">
                ...
                <div className="text-gray-400 grid grid-cols-3 col-span-4 px-[1px]">
                  <PredictionButton text={value.value1} className={'rounded-tl-lg rounded-bl-lg my-1'} />
                  <PredictionButton text={value.value2} className={'my-1'} />
                  <PredictionButton text={value.value3} className={'rounded-tr-lg my-1 rounded-br-lg'} />
                </div>
                <div className="text-gray-400 grid grid-cols-3 col-span-4 px-[1px]">
                  <PredictionButton text={value.value4} className={'rounded-tl-lg my-1 rounded-bl-lg'} />
                  <PredictionButton text={value.value5} className={'my-1'} />
                  <PredictionButton text={value.value6} className={'rounded-tr-lg my-1 rounded-br-lg'} />
                </div>
