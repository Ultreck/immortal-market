...
const PlaceOrder = ({ id, text, type, state, dissable, setWinning, shouldStart }) => {
 ...
 useEffect(()=>{
  ...
  return (
    <>
      <Button onPress={onOpen} isDisabled={(type === 'buy' && shouldStart) || (type === 'sell' && (totalOrder <= 0 || shouldStart))} color={type === 'buy' ? 'primary' : 'danger'} radius="full" className='w-32'>
        {text}
      </Button>
