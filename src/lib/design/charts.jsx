...
export const advanced = [
  {
    ...
    data: {
      ...
      config: {
        ...
        gap: 2,
        size: 20,
        label: { enabled: true, fontSize: 40, color: '#000', position: 'top' },
      },
    },
    preview: (
  ...
  },
  {
    ...
    data: {
      ...
      config: {
        ...
        progress: 50,
        colors,
        label: { enabled: true, fontSize: 16, color: '#000', position: 'top' },
      },
    },
    preview: (
      <div className="text-black/40 dark:text-white/70 hover:text-black/50 dark:hover:text-white/60 aspect-square">
  ...
  },
  {
    ...
    data: {
      ...
      config: {
        ...
        progress: 80,
        colors,
        label: { enabled: true, fontSize: 90, color: '#000000', format: 'value' },
      },
    },
    preview: (
      <div className="text-black/40 dark:text-white/70 hover:text-black/50 dark:hover:text-white/60 aspect-square">
  ...
  },
  {
    ...
    data: {
      ...
      config: {
        ...
        fontSize: 96,
        label: { enabled: true, fontSize: 16, color: '#fff', position: 'top' },
      },
    },
    preview: (
      <div className="text-black/40 dark:text-white/70 hover:text-black/50 dark:hover:text-white/60 aspect-square">
  ...
  },
  {
    ...
    data: {
      ...
      config: {
        ...
        data: [
          { label: 'Bubble 1', value: 30, icon: 'user' },
          { label: 'Bubble 2', value: 50, icon: 'home' },
          { label: 'Bubble 3', value: 20, icon: 'check' },
          { label: 'Bubble 4', value: 40, icon: 'bell' },
          { label: 'Bubble 5', value: 60, icon: 'star' },
        ],
        keys: { label: 'label', value: 'value', icon: 'icon' },
        colors,
        count: 5,
        shape: 'circle',
        isValueVisible: true,
        label: { enabled: true, fontSize: 16, color: '#000', format: 'value' },
      },
    },
    preview: (
      <div className="text-black/40 dark:text-white/70 hover:text-black/50 dark:hover:text-white/60 aspect-square">
